...
def ssd_build_gt_batch(batch_gt,image_shape,num_classes):
    ...
    for i,gt in enumerate(batch_gt):
        ...
        for j,obj in enumerate(objects):
            ...
            assigned = assign_boxes(box, num_classes, priors)
            
            batch_y.append(assigned)
    return batch_y
...
def ssd_detection_out(predictions, labels, threshold, nms_threshold, background_label_id=0, keep_top_k=200):
