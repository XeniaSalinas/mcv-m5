...
weights_file                 = 'weights_tt100k_yolo_taska.hdf5'  # Training weight file name
...
learning_rate                = 0.000005         # Training learning rate
...
lrDecayScheduler_epochs      = [2, 6]     # List of epochs were decay is applied or None for all epochs
