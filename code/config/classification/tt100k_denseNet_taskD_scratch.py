...
# Model
model_name                   = 'denseNet'          # Model to use ['fcn8' | 'lenet' | 'alexNet' | 'vgg16' |  'vgg19' | 'resnet50' | 'InceptionV3']
...
resize_train                 = (32,32)      # Resize the image during training (Height, Width) or None
resize_valid                 = (32,32)      # Resize the image during validation
resize_test                  = (32,32)      # Resize the image during testing
