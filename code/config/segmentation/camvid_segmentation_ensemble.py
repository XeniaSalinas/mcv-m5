...
# Model 2 used for Ensemble models
model_name_2                  = 'segnet_vgg'            # Model to use ['fcn8' | 'lenet' | 'alexNet' | 'vgg16' |  'vgg19' | 'resnet50' | 'InceptionV3']
weights_file_2                = 'weights_model2.hdf5'   # Training weight file name of the second model
